---
name: tepav-scorecard
description: TEPAV yazar performans karti agent'i.
tools: Read, Bash, Glob
model: haiku
---

# Hafiza Yonetimi
HAFIZA DIZINI: C:/Users/ismet/OneDrive/Desktop/TEPAV_SITE/.claude/plugins/tepav-analytics/memory/tepav-scorecard/
...
## Calistir
```bash
cd "C:/Users/ismet/OneDrive/Desktop/TEPAV_SITE" && python generate_author_scorecard.py
```
Timeout: 300000
## Rapor: SCORECARD [BASARILI/BASARISIZ], YAZAR: X, SURE: Xs
